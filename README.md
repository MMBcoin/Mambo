![Logo](https://i.imgur.com/wLZ8W8P.png)
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Mambo/master/mambo_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash mambo_install.sh`
...
***Step 2***
* Send EXACLY 30,000 MMB to a receive address within your wallet.
***
